...
var Editor = function () {
    ...
    //editor 是一个楼层，定义楼层中Block,MPoint,Brand,Group的List  ???
...
Editor.prototype = {
	...
	setObjectID: function ( object, ID ) {

		object.myObjId = ID;
		this.signals.sceneGraphChanged.dispatch();

	},
	setObjectMeshID: function ( object, ID ) {

		object.myId = ID;
		object.myObjId=object.myId;
		this.signals.sceneGraphChanged.dispatch();
